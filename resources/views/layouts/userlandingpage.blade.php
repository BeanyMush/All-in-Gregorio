            ...
            <div class="flex flex-wrap -m-4">
                <div class="p-4 xl:w-1/4 md:w-1/2 w-full">
                    <div class="h-full p-6 rounded-lg border-2 border-blue-800 flex flex-col relative overflow-hidden">
                        ...
                        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                            stroke-width="1.5"
                            class="text-lime-300 w-28 h-28 mb-3 flex justify-center items-center mx-auto pb-4 mb-4 border-b border-gray-200 leading-none"
                            viewBox="0 0 24 24">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5}
                                stroke="currentColor" className="w-6 h-6">
                                <path strokeLinecap="round" strokeLinejoin="round"
                ...
                <div class="flex items-center justify-center lg:w-3/5 md:w-2/3 mx-auto">
                    <a href="./services">
                    <button
