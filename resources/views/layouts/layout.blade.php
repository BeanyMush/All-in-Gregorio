...
<body class="font-sans antialiased">
    <header class="text-gray-600 body-font bg-white shadow-lg sticky top-0 z-50">
        <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <a href="{{ route('login') }}">
            <button
                class="inline-flex items-center bg-blue-800 border-0 py-1 px-3 mr-4 focus:outline-none hover:bg-lime-400 rounded text-base text-white font-medium mt-4 md:mt-0">Login
            </button>
            </a>
            <a href="{{ route('register') }}">
            <button
                class="inline-flex items-center bg-blue-800 border-0 py-1 px-3 focus:outline-none hover:bg-lime-400 rounded text-base text-white mt-4 font-medium md:mt-0">Register
            </button>
            </a>
        </div>
    </header>
